...
class DemoPublishedPostsSeeder extends Seeder
{
    ...
    private function posts(): array
    {
        return [
            ...
            [
                'title' => 'Demo: Homemade Ramen Bowl',
                'description' => 'A rich broth with noodles, egg, and scallions for longer feed checks.',
                'image_path' => 'demo/posts/ramen.jpg',
                'author' => 'alice@rateguru.test',
                'origin_truth' => OriginType::Homemade,
                'cuisine_truth' => CuisineType::Asian,
                'tags' => ['asian', 'homemade', 'comfort-food'],
            ],
            [
                'title' => 'Demo: Restaurant Burger Tray',
                'description' => 'Burger, fries, and sauce from a casual restaurant service.',
                'image_path' => 'demo/posts/burger.jpg',
                'author' => 'bob@rateguru.test',
                'origin_truth' => OriginType::Restaurant,
                'cuisine_truth' => CuisineType::American,
                'tags' => ['american', 'restaurant', 'comfort-food'],
            ],
            [
                'title' => 'Demo: Homemade Berry Pancakes',
                'description' => 'A breakfast stack with berries for lazy loading and profile pagination checks.',
                'image_path' => 'demo/posts/berry-pancakes.jpg',
                'author' => 'trusted@rateguru.test',
                'origin_truth' => OriginType::Homemade,
                'cuisine_truth' => CuisineType::American,
                'tags' => ['american', 'breakfast', 'homemade'],
            ...
            [
                'title' => 'Demo: Restaurant Enchiladas',
                'description' => 'Sauced enchiladas with rice and beans from a restaurant plate.',
                'image_path' => 'demo/posts/enchiladas.jpg',
                'author' => 'carla@rateguru.test',
                'origin_truth' => OriginType::Restaurant,
                'cuisine_truth' => CuisineType::Mexican,
                'tags' => ['mexican', 'restaurant', 'spicy'],
            ],
            [
                'title' => 'Demo: Homemade Caprese Toast',
                'description' => 'Tomato, mozzarella, basil, and olive oil on crisp toast.',
                'image_path' => 'demo/posts/caprese-toast.jpg',
                'author' => 'alice@rateguru.test',
                'origin_truth' => OriginType::Homemade,
                'cuisine_truth' => CuisineType::Italian,
                'tags' => ['italian', 'healthy', 'homemade'],
            ],
            [
                'title' => 'Demo: Restaurant Noodle Salad',
                'description' => 'Cold noodles with vegetables and sesame dressing for cuisine voting checks.',
                'image_path' => 'demo/posts/noodle-salad.jpg',
                'author' => 'bob@rateguru.test',
                'origin_truth' => OriginType::Restaurant,
                'cuisine_truth' => CuisineType::Asian,
                'tags' => ['asian', 'healthy', 'restaurant'],
            ],
            [
                'title' => 'Demo: Homemade Chili Bowl',
                'description' => 'Beans, peppers, and warm spices in a home-cooked bowl.',
                'image_path' => 'demo/posts/chili.jpg',
                'author' => 'trusted@rateguru.test',
                'origin_truth' => OriginType::Homemade,
                'cuisine_truth' => CuisineType::American,
                'tags' => ['american', 'spicy', 'homemade'],
            ],
            [
                'title' => 'Demo: Restaurant Dessert Flight',
                'description' => 'Small desserts served together for feed scrolling and comments checks.',
                'image_path' => 'demo/posts/dessert-flight.jpg',
                'author' => 'carla@rateguru.test',
                'origin_truth' => OriginType::Restaurant,
                'cuisine_truth' => CuisineType::Other,
                'tags' => ['dessert', 'restaurant', 'comfort-food'],
