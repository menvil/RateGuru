...
it('does not add any new lifecycle model events to MediaAsset or MediaVariant', function () {
    ...
    // method (or deleting/deleted/forceDeleted listeners) on either model
    // at all. All lifecycle logic lives in MediaLifecycleService/the
    // console commands/DeleteUserAccountAction instead.
